 ...
 *
 * Remove duplicate letters so every letter appears exactly once and the result
 * is the lexicographically smallest among all valid results, keeping the
 * original relative order of the letters kept.
 *
 * Time:  O(n)
...
public class RemoveDuplicateLetters {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sol.removeDuplicateLetters("abacb"));      // expected "abc"
        System.out.println(sol.removeDuplicateLetters("bbcaac"));     // expected "bac"
        System.out.println(sol.removeDuplicateLetters("a"));          // expected "a"
    }
}
