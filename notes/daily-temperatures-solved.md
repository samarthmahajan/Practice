...
## Core Insight
Monotonic stack of INDICES; the answer is a distance = warmer index minus current index.

## Watch Out For
- Store indices not values; pop on <= so equal temps do not block the real warmer day.
